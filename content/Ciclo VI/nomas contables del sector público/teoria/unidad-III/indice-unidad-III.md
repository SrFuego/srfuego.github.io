---
title: "Índice Unidad III - Normas Internacionales de Contabilidad del Sector Público: Ingresos y Gastos"
author: Comité Multidisciplinario de Expertos
date: 2025-11-06
tags: [unidad-3, indice, nicsp, ingresos, gastos, ipsas]
...
```mermaid
graph TD
    A[UNIDAD III: Ingresos y Gastos NICSP] --> B[INGRESOS]
    A --> C[GASTOS]

    B --> B1[Marco Conceptual Ingresos]
    B1 --> B11[NICSP 9: Ingresos Cambio]
    B1 --> B12[NICSP 23: Ingresos Sin Contraprestación]
    B1 --> B13[NICSP 47: Nueva Norma Unificada]

    B11 --> B11A[Venta bienes/servicios]
    B12 --> B12A[Impuestos + Transferencias]
    B13 --> B13A[Modelo 5 pasos - Vigente 2026]

    C --> C1[Marco Conceptual Gastos]
    C1 --> C11[NICSP 39: Beneficios Empleados]
    C1 --> C12[NICSP 42: Beneficios Sociales]
    C1 --> C13[NICSP 48: Gastos Transferencias]

    C11 --> C11A[Salarios + Pensiones]
    C12 --> C12A[Pensión 65 + Juntos]
    C13 --> C13A[Canon + Donaciones]

    style A fill:#FFD700
    style B fill:#90EE90
    style C fill:#FF6347
    style B13 fill:#87CEEB
    style C13 fill:#87CEEB
```
